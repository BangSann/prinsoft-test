...
<body>
    <section class="container mx-auto p-5 flex justify-center items-center h-screen">
        <section class="w-1/3 p-5 border border-gray-300 rounded-md shadow-md">
            <h2 class="mb-6 text-lg font-semibold">Tambah Produk</h2>
            <form action="<?= site_url('produk/store') ?>" method="post" class="space-y-4">
                ...
                <input type="text" name="kategori" class="w-full border border-gray-300 rounded-md px-3 py-2" required>

                <label>Jenis Formula</label>
                <input type="text" name="jenis_formula" class="w-full border border-gray-300 rounded-md px-3 py-2"
                    required>

                <label>Harga (Rp)</label>
                <input type="number" name="satuan" class="w-full border border-gray-300 rounded-md px-3 py-2" required>

                <label>Deskripsi</label><br>
                <textarea name="deskripsi" class="w-full border border-gray-300 rounded-md px-3 py-2"></textarea>

                <button type="submit" class="py-2 px-3 bg-blue-500 text-white rounded-md">Simpan</button>
